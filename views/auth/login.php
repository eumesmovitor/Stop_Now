    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Ou
                <a href="<?php echo BASE_URL; ?>/register" class="font-medium text-accent hover:text-accent-dark">
                    crie uma nova conta
                </a>
            </p>
        </div>
        
        <form class="mt-8 space-y-6" method="POST" action="<?php echo BASE_URL; ?>/login">
